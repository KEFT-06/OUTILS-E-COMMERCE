...
const MODULES: readonly ModuleEntry[] = [
  ...
  { id: 'affiliation', num: '07', fr: 'Affiliation', en: 'Affiliate Program', descFr: 'Liens UTM, suivi et invitations', descEn: 'UTM links, tracking and invitations', icon: Users, ready: true },
