...
import { type Guide, coversApi, guidesApi } from '@/modules/m10-multilingue/guidesApi';
import { GUIDE_DOCUMENT_CSS, exportNotice, guideDocumentOf, paragraphsOf } from '@/modules/m10-multilingue/guideExport';
